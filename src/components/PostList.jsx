...
const PostList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const responseUser = await axios.get("https://apcbrd.com/wp-json/wp/v2/users/me", {
          headers: {
        ...
        const response = await fetch(
          "https://apcbrd.com/wp-json/wp/v2/posts",
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(
        `https://apcbrd.com/wp-json/wp/v2/posts/${postToDelete}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
